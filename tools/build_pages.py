  ...
  <section id="enquire" class="section section--alt">
    ...
    <div class="section__body enquire">
      <div class="enquire__intro">
        <h2>Send a note</h2>
        <p>This goes straight to my inbox. There's no payment on the site — no card
          details, no checkout — just a message, and I'll reply to you directly.</p>
      ...
      <form class="form" name="enquiry" method="POST" data-netlify="true" netlify-honeypot="bot-field" action="/thanks.html">
        ...
        <div class="form__foot">
          ...
          <span class="fineprint">I'll reply within a day or two.</span>
        </div>
  ...
  <section class="section page-head">
    ...
    <div class="section__body">
      ...
      <p class="note">Nothing is sold through the site. Use <strong>Enquire</strong> on any
        piece and I'll come back to you with sizing, colours and price.</p>
    </div>
  </section>
...
<main id="main">
  ...
  <section class="hero">
    <div class="hero__text">
      ...
      <p class="lede reveal">Beadwell is a one-person workshop making crochet pieces and
        beaded jewellery in small numbers. Nothing here is mass-made, and nothing comes
        out quite the same way twice.</p>
  ...
  <section id="collection" class="section">
    ...
    <div class="section__body">
      <header class="section__head">
        <h2>Three things I make</h2>
        <p class="note">There's no checkout here — this is a place to look rather than buy.
          If something catches your eye, use <strong>Enquire</strong> and I'll come back to
          you with sizing, colours and price.</p>
      </header>
      <div class="cats">
{cards}      </div>
    </div>
  ...
  <section id="about" class="section section--alt">
    ...
    <div class="section__body about">
      <div class="about__text">
        ...
        <p>I've been crocheting since I was small and beading for nearly as long. What
          started as something to do with my hands in the evening turned into more pieces
          than the house can reasonably hold, which is how this page came about.</p>
        <p>Everything is made by me, at home, from materials I've picked myself — natural
          fibres where I can, glass and real stone rather than plastic, and proper findings
          so a clasp doesn't give out after a fortnight. A bracelet takes an evening. A
          blanket takes considerably longer.</p>
        <p>Colours are the part I enjoy most. If you like a piece but not its palette,
          that's an easy thing to change — most of what you see here can be remade in
          whatever suits you.</p>
        <p>I'm not a shop and I don't want to be one. If something here appeals, send a
    ...
    <div class="section__body">
      ...
      <ol class="steps">
        <li>
          ...
          <h3>Send a note</h3>
          <p>Tell me what you're after — a piece from the collection in different colours,
        ...
        <li>
          ...
          <p>I'll come back with materials, colours, sizing, a price and a rough timescale.
            Nothing starts until you're happy with all of it.</p>
        </li>
        <li>
          <span class="steps__num">03</span>
          <h3>It gets made</h3>
          <p>I'll send a photo or two along the way. Small pieces take a week or so; larger
            crochet work takes longer and I'll always say so up front.</p>
        </li>
      </ol>
    </div>
  </section>
